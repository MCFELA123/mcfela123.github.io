...
<small class="text-danger"><?= $user_login_err; ?></small><br>
    <small><div class="text-danger"><?= $user_password_err; ?></div></small>
...
<div id="linker">
<button class="btn-primary" id="toggle" onclick="show()">Login</button><br>
<a href="register.php"><button class="btn-primary bd-0">Sign up</button></a>
</div>
<div id="contents">
<form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
<div class="input-bar">
    <label for="name">Name</label>
      <input type="email" placeholder="Email or username"  name="user_login" id="name" value="<?= $user_login; ?>">
            </div>

<br>
            <div class="input-bar">
    <label for="password">Password</label>
      <input type="password" placeholder="Password"  name="user_password" id="password" oncontextmenu="copy()">
            </div>

<br>
<input type="submit" class="sbtn" name="submit" value="Log In">
<br>
...
window.onload = function() {setTimeout(stats, 400),show}
